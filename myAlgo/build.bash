...
g++ -std=c++11 -o trader.exe main.cpp trading/Order.cpp trading/Strategy.cpp trading/Holding.cpp trading/Portfolio.cpp trading/Trader.cpp trading/Stats.cpp tools/FileReadingUtilities.cpp tools/FileWritingUtilities.cpp tools/NetworkingUtilities.cpp -lcurl
